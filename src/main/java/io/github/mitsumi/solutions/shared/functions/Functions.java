...
@SuppressWarnings({"PMD.CouplingBetweenObjects", "PMD.TooManyMethods", "PMD.CommentSize"})
public class Functions {
     ...
     * @param <T>       type of the supplier.
     */
    public <T> void runElse(final Supplier<T> supplier,
     ...
     */
    public <T, U extends RuntimeException> void throwsIf(final Supplier<T> supplier,
                                                         final Predicate<T> predicate,
     ...
     * @return the result of the function.
     */
    public <T, U, R> R apply(final Supplier<T> supplierT,
                             final Supplier<U> supplierU,
     ...
     * @return the result of the function.
     */
    public <T, U, V, R> R apply(final Supplier<T> supplierT,
                                final Supplier<U> supplierU,
                                final Supplier<V> supplierV,
     ...
     * @return the result of the function.
     */
    public <T, U, V, W, R> R apply(final Supplier<T> supplierT,
                                   final Supplier<U> supplierU,
                                   final Supplier<V> supplierV,
                                   final Supplier<W> supplierW,
     ...
     * @return the result of the function.
     */
    public <T, U, V, W, X, R> R apply(final Supplier<T> supplierT,
                                      final Supplier<U> supplierU,
                                      final Supplier<V> supplierV,
                                      final Supplier<W> supplierW,
                                      final Supplier<X> supplierX,
     ...
     * @return the result of the function.
     */
    public <T, U, V, W, X, Y, R> R apply(final Supplier<T> supplierT,
                                         final Supplier<U> supplierU,
                                         final Supplier<V> supplierV,
                                         final Supplier<W> supplierW,
                                         final Supplier<X> supplierX,
                                         final Supplier<Y> supplierY,
     ...
     * @return the result of the function.
     */
    public <T, R> R applyOrElse(final boolean condition,
                                final Supplier<T> supplierT,
     ...
     * @return the result of the function.
     */
    public <T, U, R> R applyOrElse(final boolean condition,
                                   final Supplier<T> supplierT,
                                   final Supplier<U> supplierU,
                                   final BiFunction<T, U, R> function,
                                   final Supplier<R> supplierR) {
     ...
     * @return the result of the function.
     */
    public <T, U, V, R> R applyOrElse(final boolean condition,
                                      final Supplier<T> supplierT,
                                      final Supplier<U> supplierU,
                                      final Supplier<V> supplierV,
                                      final TriFunction<T, U, V, R> function,
     ...
     * @return the result of the function.
     */
    public <T, U, V, W, R> R applyOrElse(final boolean condition,
                                         final Supplier<T> supplierT,
                                         final Supplier<U> supplierU,
                                         final Supplier<V> supplierV,
                                         final Supplier<W> supplierW,
     ...
     * @return the result of the function.
     */
    public <T, U, V, W, X, R> R applyOrElse(final boolean condition,
                                            final Supplier<T> supplierT,
                                            final Supplier<U> supplierU,
                                            final Supplier<V> supplierV,
                                            final Supplier<W> supplierW,
     ...
     * @param <T>       type of the supplier.
     */
    public <T> void acceptIf(final boolean condition,
                             final Supplier<T> supplierT,
     ...
     *
     * @param condition      condition to test.
     * @param firstSupplier  value supplier.
     * @param secondSupplier value supplier.
     * @param consumer       action to perform.
     * @param <T>            type of the supplier.
     * @param <V>            type of the supplier.
     */
    public <T, V> void acceptIf(final boolean condition,
                                final Supplier<T> firstSupplier,
                                final Supplier<V> secondSupplier,
     ...
     * @param <T>       type of the supplier.
     */
    public <T> void acceptOrElse(final boolean condition,
                                 final Supplier<T> supplierT,
                                 final Consumer<T> consumer,
     ...
     * @param <V>            type of the supplier.
     */
    public <T, V> void accept(final Supplier<T> firstSupplier,
                              final Supplier<V> secondSupplier,
                              final BiConsumer<T, V> consumer) {
        consumer.accept(firstSupplier.get(), secondSupplier.get());
    }
     ...
     * @param firstSupplier  value supplier.
     * @param secondSupplier value supplier.
     * @param thirdSupplier  value supplier.
     * @param consumer       action to perform.
     * @param <T>            type of the supplier.
     * @param <U>            type of the supplier.
     * @param <V>            type of the supplier.
     */
    public <T, U, V> void accept(final Supplier<T> firstSupplier,
                                 final Supplier<U> secondSupplier,
                                 final Supplier<V> thirdSupplier,
     ...
     * @param secondSupplier value supplier.
     * @param thirdSupplier  value supplier.
     * @param fourthSupplier value supplier.
     * @param consumer       action to perform.
     * @param <T>            type of the supplier.
     * @param <U>            type of the supplier.
     * @param <V>            type of the supplier.
     * @param <W>            type of the supplier.
     */
    public <T, U, V, W> void accept(final Supplier<T> firstSupplier,
                                    final Supplier<U> secondSupplier,
                                    final Supplier<V> thirdSupplier,
                                    final Supplier<W> fourthSupplier,
     ...
     * @param thirdSupplier  value supplier.
     * @param fourthSupplier value supplier.
     * @param fifthSupplier  value supplier.
     * @param consumer       action to perform.
     * @param <T>            type of the supplier.
     * @param <U>            type of the supplier.
     * @param <V>            type of the supplier.
     ...
     * @param <X>            type of the supplier.
     */
    public <T, U, V, W, X> void accept(final Supplier<T> firstSupplier,
                                       final Supplier<U> secondSupplier,
                                       final Supplier<V> thirdSupplier,
                                       final Supplier<W> fourthSupplier,
                                       final Supplier<X> fifthSupplier,
                                       final PentaConsumer<T, U, V, W, X> consumer) {
        consumer.accept(
            firstSupplier.get(), secondSupplier.get(),
            thirdSupplier.get(), fourthSupplier.get(), fifthSupplier.get()
        );
    }
